  ...
  return (
    <Box className={styling.root}>
      ...
      <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
        <LineChart dataArray={PuttsPerGIR} title="Putts Avg GIR" average={true} last={7} />
        <LineChart dataArray={PuttsNoGIR} title="Putts Avg NO GIR" average={true} last={7} />
        <LineChart dataArray={PuttsPerRound} title="Putts Per Round" average={true} />
      </Box>

      <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
        <LineChart dataArray={SandSaves} title="Greenside Sand Save %" average={true} last={7} />
        <LineChart dataArray={UpAndDowns} title="Up and Down %" average={true} last={7} />
      </Box>
    </Box>
  )
}
