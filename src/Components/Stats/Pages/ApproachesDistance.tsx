...
const ApproachesbyDistanceStats: React.FC<propsData> = ({ gir, approachdistances }) => {
  ...
  const countGirMissDirectionsForChart = (girData: string[], approachData: string[], mindistance: number, maxdistance: number): GirMissesArrData[][] => {
  ...
  return (
    <Box className={styling.root}>
      ...
      <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
        <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
          <BarChart data={GirMissDirections2550} title="Left or Right? (25-50 m)" width={400} />
          <BarChart data={GirMissLength2550} title="Long or Short?  (25-50 m)" width={400} />
        </Box>
        <Box className={window.innerWidth > 1200 ? styling.pairrow : styling.column}>
          <BarChart data={GirMissDirections5075} title="Left or Right? (50-75 m)" width={400} />
          <BarChart data={GirMissLength5075} title="Long or Short?  (50-75 m)" width={400} />
        </Box>
        <Box className={window.innerWidth > 1200 ? styling.pairrow : styling.column}>
      ...
      <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
        <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
          <BarChart data={GirMissDirections100125} title="Left or Right?  (100 - 125 m)" width={400} />
          <BarChart data={GirMissLength100125} title="Long or Short?   (100 - 125 m)" width={400} />
        </Box>

        <Box className={window.innerWidth > 1200 ? styling.pairrow : styling.column}>
          <BarChart data={GirMissDirections125150} title="Left or Right?  (125 - 150 m)" width={400} />
          <BarChart data={GirMissLength125150} title="Long or Short?   (125 - 150 m)" width={400} />
        </Box>

        <Box className={window.innerWidth > 1200 ? styling.pairrow : styling.column}>
          <BarChart data={GirMissDirections150175} title="Left or Right?  (150 - 175 m)" width={400} />
          <BarChart data={GirMissLength150175} title="Long or Short?   (150 - 175 m)" width={400} />
        </Box>
      </Box>
    </Box>
  )
