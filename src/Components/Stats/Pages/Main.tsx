  ...
  return (
    <Box className={styling.root}>
      ...
      <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
        <LineChart dataArray={Scores} title="Shots" average={true} />
        <LineChart dataArray={Putts} title="Putts" average={true} />
        <LineChart dataArray={GIR} title="GIR" average={true} />
      </Box>

      <Box className={window.innerWidth > 1200 ? styling.row : styling.column}>
        <LineChart dataArray={FIR} title="FIR" average={true} />
        <LineChart dataArray={Penalties} title="Penalties" average={true} />
        <LineChart dataArray={GreenBunkers} title="Green Bunkers" average={true} />
      </Box>
    </Box>
  )
}
