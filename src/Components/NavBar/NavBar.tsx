...
const NavBar: React.FC = () => {
  ...
  return (
    <Box className={styling.root}>
      <Tabs indicatorColor="primary" textColor="inherit" aria-label="Page Tab Selector" onChange={handleTabChange} value={SelectedTab} centered>
        <Tab label="Stats" />
        <Tab label="Past Rounds" />
      </Tabs>
      <Button variant="outlined" style={{ marginLeft: '50px' }} onClick={handleNewRoundStart}>
        Start a New Round
      </Button>
    </Box>
  )
