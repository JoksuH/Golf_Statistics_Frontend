    ...
    <Box className={styling.root}>
      ...
      <Box className={styling.holenumbers}>
              ...
              <Box className={styling.holepaircontainer}>
                ...
                {parseInt(Strokes[index]) === number - 2 && (
                  <Box className={styling.scoreeagle}>
                    <Typography variant="h6">{Strokes[index]}</Typography>
                  </Box>
                )}
                {parseInt(Strokes[index]) === number && (
                ...
                <Box className={styling.iconcontainer}>
                  <Typography variant="h6">{Putts[index]}</Typography>
                </Box>
                {number !== 3 ? (
                  <Box className={styling.iconcontainer}>
                ...
                <Box className={styling.scorecontainer}>
                  <Typography variant="h6">{Penalties[index]}</Typography>
                </Box>
                <Box className={styling.scorecontainer}>
                  <Typography variant="h6">{GreenBunkers[index]}</Typography>
                </Box>
                <Box className={styling.scorecontainer}>
        ...
        <Box className={styling.holepaircontainer}>
          ...
          <Box className={styling.scorecardsums}>
            <Typography variant="h6">{sumScores(stringPars)}</Typography>
          </Box>
          <Box className={styling.scorecardsums}>
            <Typography variant="h6">{sumScores(Strokes)}</Typography>
          </Box>
          <Box className={styling.scorecardsums}>
            <Typography variant="h6">{sumScores(Putts)}</Typography>
          </Box>
          <Box className={styling.scorecardsums}>
            <Typography variant="h6">{hitCounter(Fairways, 'hit')}</Typography>
          </Box>
          ...
          <Box className={styling.scorecardsums}>
            <Typography variant="h6">{sumScores(Penalties)}</Typography>
          </Box>
          <Box className={styling.scorecardsums}>
            <Typography variant="h6">{sumScores(GreenBunkers)}</Typography>
          </Box>
          <Box className={styling.scorecardsums}>
            <Typography variant="h6">{sumScores(FWBunkers)}</Typography>
          </Box>
        </Box>
      </Box>
    </Box>
