...
const RoundListItem: React.FC<props> = ({ name, score, date, onClick, index }) => {
  ...
  return (
    <Box className={window.innerWidth > 1200 ? styling.listitem : styling.listitemmobile} onClick={onClick} id={index.toString()}>
      <Typography className={styling.coursename} id={index.toString()}>
        {name}
      </Typography>
